...
const Skiper26 = () => {
    ...
    return (
        <div className='relative flex h-full w-full flex-col items-center justify-center py-64 pb-6'>
            <div className='mx-auto flex max-w-lg -translate-y-16 flex-col items-center justify-center space-y-5'>
                ...
                <Dialog>
                    <DialogTrigger>
                        <Input placeholder='Search DeepServices...' />
                    </DialogTrigger>
                    <DialogContent>
                        <DialogHeader>
                            <DialogDescription>
        ...
        <span className="after:from-background after:to-foreground relative max-w-[12ch] text-xs uppercase leading-tight opacity-40 after:absolute after:left-1/2 after:top-full after:h-16 after:w-px after:bg-gradient-to-b after:content-['']">
          Click to toggle the theme
            ...
            <div className='fixed right-4 bottom-4 z-50'>
                <ThemeToggleButton variant={'circle'} start={'bottom-right'} blur={true} gifUrl={gifUrl} />
            </div>
            {/* <Options
        variant={variant}
        start={start}
